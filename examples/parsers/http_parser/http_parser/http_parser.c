...
typedef struct
{
    PyObject_HEAD http_parser* http;
} HTTPParser;
...
static PyObject* HTTPParser_new(PyTypeObject* type, PyObject* args,
                                PyObject* kwargs)
{
...
static PyObject* HTTPParser_execute(PyObject* self, PyObject* args,
                                    PyObject* kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "Osi:execute", kwlist,
                                     &req_hash, &data, &start))
        return NULL;
...
PyTypeObject PyHTTPParser_Type = {
    PyVarObject_HEAD_INIT(&PyType_Type, 0) "http_parser", /* tp_name */
