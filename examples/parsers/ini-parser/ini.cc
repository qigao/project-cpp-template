...
static char const _parser_trans_keys[] = {
    ...
    57, 65, 90, 97,  122, 45, 93,  95, 48,  57, 65, 90, 97, 122, 10, 10,
    39, 45, 95, 48,  57,  65, 90,  97, 122, 10, 39, 45, 93, 95,  48, 57,
    65, 90, 97, 122, 10,  35, 45,  59, 91,  95, 48, 57, 65, 90,  97, 122,
...
static char const _parser_indicies[] = {
    ...
    1,  2,  12, 2,  21, 21, 21, 21, 21, 11, 12, 2,  22, 23, 22, 22, 22, 22,
...
public:
    ...
    parser()
        : cs(0), mark(0), nread(0), section(nullptr){
