...
GLEXTERN void(APIENTRY *glUniformMatrix3fv)(GLint location,
  GLsizei                                         count,
  GLboolean                                       transpose,
  const GLfloat                                  *value);
...
GLEXTERN void(APIENTRY *glFramebufferTexture2D)(GLenum target,
  GLenum                                               attachment,
  GLenum                                               textarget,
  GLuint                                               texture,
  GLint                                                level);
GLEXTERN void(APIENTRY *glFramebufferRenderbuffer)(GLenum target,
  GLenum                                                  attachment,
  GLenum                                                  renderbuffertarget,
  GLuint                                                  renderbuffer);
GLEXTERN void(APIENTRY *glRenderbufferStorage)(GLenum target,
...
GLEXTERN void(APIENTRY *glVertexAttribPointer)(GLuint index,
  GLint                                               size,
  GLenum                                              type,
...
GLEXTERN void(APIENTRY *glShaderSource)(GLuint shader,
  GLsizei                                      count,
...
GLEXTERN void(APIENTRY *glUniformMatrix4fv)(GLint location,
  GLsizei                                         count,
  GLboolean                                       transpose,
  const float                                    *value);
...
GLEXTERN void(
  APIENTRY *glBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data);
GLEXTERN void(APIENTRY *glGenVertexArrays)(GLsizei n, const GLuint *arrays);
GLEXTERN void(
  APIENTRY *glGetShaderInfoLog)(GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
GLEXTERN void(
  APIENTRY *glGetProgramInfoLog)(GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
GLEXTERN GLuint(APIENTRY *glGetUniformBlockIndex)(GLuint program, const GLchar *uniformBlockName);
GLEXTERN void(APIENTRY *glUniformBlockBinding)(GLuint program,
...
GLEXTERN void(APIENTRY *glDrawElementsInstancedBaseVertex)(GLenum mode,
  GLsizei                                                         count,
  GLenum                                                          type,
  const void                                                     *indices,
  GLsizei                                                         primcount,
...
GLEXTERN void(APIENTRY *glBlendFuncSeparate)(GLenum sfactorRGB,
  GLenum                                            dfactorRGB,
  GLenum                                            sfactorAlpha,
  GLenum                                            dfactorAlpha);
GLEXTERN void(
  APIENTRY *glGetBufferSubData)(GLenum target, GLintptr offset, GLsizeiptr size, GLvoid *data);
GLEXTERN void(
  APIENTRY *glGetShaderSource)(GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *source);
GLEXTERN GLboolean(APIENTRY *glIsProgram)(GLuint program);
GLEXTERN void(APIENTRY *glGetAttachedShaders)(GLuint program,
  GLsizei                                            maxCount,
  GLsizei                                           *count,
  GLuint                                            *shaders);
GLEXTERN void(APIENTRY *glDrawBuffers)(GLsizei n, const GLenum *bufs);
GLEXTERN void(APIENTRY *glBlitFramebuffer)(GLint srcX0,
  GLint                                          srcY0,
  GLint                                          srcX1,
  GLint                                          srcY1,
  GLint                                          dstX0,
...
struct ImApp
{
  ImApp() : mInitExtensionsDone(false), mExtensionsPresent(false), mDone(true) { mInstance = this; }
  ~ImApp() { mInstance = NULL; }
  ...
  int           Init(const Config &config = Config())
  {
    ...
    static DEVMODEA screenSettings = {
      { 0 },
      ...
      0,
      32,
      static_cast<DWORD>(config.mWidth),
      static_cast<DWORD>(config.mHeight),
      { 0 },
    ...
    if (config.mFullscreen) {
      if (config.mFullscreen
          && ChangeDisplaySettingsA(&screenSettings, CDS_FULLSCREEN) != DISP_CHANGE_SUCCESSFUL)
        return 0;
    }
#ifdef IMGUI_API
    ImGui::CreateContext();
    ...
    ERRCHECK(lowLevelSystem->setSoftwareFormat(
      0, FMOD_SPEAKERMODE_STEREO, 0));// on rajoute la config pour le stereo

#ifdef RETAIL
    ERRCHECK(system->initialize(32, FMOD_STUDIO_INIT_NORMAL, FMOD_INIT_NORMAL, extraDriverData));
#else
    ERRCHECK(system->initialize(32,
      FMOD_STUDIO_INIT_NORMAL | FMOD_STUDIO_INIT_LIVEUPDATE | FMOD_STUDIO_INIT_SYNCHRONOUS_UPDATE,
  ...
  void NewFrame()
  {
    ...
    while (PeekMessage(&msg, NULL, 0U, 0U, PM_REMOVE)) {
      ...
      if (msg.message == WM_QUIT) mDone = true;
    }
...
protected:
  ...
  {
#ifdef IMGUI_API
    if (ImGui_WndProcHandler(hWnd, msg, wParam, lParam)) return true;
#endif
    switch (msg) {
    case WM_SIZE: {
#ifdef IMGUI_API
  ...
  int WindowInit(WININFO *info)
  {
    ...
    if (!RegisterClassExA(&WndClsEx)) return 0;
    ...
    info->hWnd = CreateWindowExA(dwExStyle,
      "ImGuizmoWndClass",
      " ",
      dwStyle | WS_MAXIMIZE,
...
#define LE(x) mExtensionsPresent &= loadExtension(#x, (void **)&x);
  ...
  bool InitExtension()
  {
    if (mInitExtensionsDone) return true;

    mExtensionsPresent = true;

    LE(glUniform1i);// GLint location, GLint v0);
    LE(glUniformMatrix3fv)// GLint location, GLsizei count, GLboolean transpose, const
                          // GLfloat* value);
#ifdef _WIN32
    ...
    LE(glFramebufferTexture2D);// GLenum target, GLenum attachment, GLenum textarget,
                               // TextureID texture, GLint level);
    LE(glFramebufferRenderbuffer);// GLenum target, GLenum attachment, GLenum
                                  // renderbuffertarget, TextureID renderbuffer);
    LE(glRenderbufferStorage);// GLenum target, GLenum internalformat, GLsizei width,
                              // GLsizei height);
    ...
    LE(glBufferData);// GLenum target, GLsizeiptr size, const GLvoid* data, GLenum
                     // usage);
    ...
    LE(glVertexAttribPointer);// TextureID index, GLint size, GLenum type, GLboolean
    ...
    LE(glShaderSource);// TextureID shader, GLsizei count, const GLchar** strings, const
                       // GLint* lengths);
    ...
    LE(glUniformMatrix4fv);// GLint location, GLsizei count, GLboolean transpose, const
                           // float* value);
    ...
    LE(glBufferSubData);// GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid*
                        // data);
    LE(glGenVertexArrays);// GLsizei n, const TextureID* arrays);
    LE(glGetShaderInfoLog);// TextureID shader, GLsizei bufSize, GLsizei* length, GLchar*
                           // infoLog);
    LE(glGetProgramInfoLog);// TextureID program, GLsizei bufSize, GLsizei* length,
                            // GLchar* infoLog);
    LE(glGetUniformBlockIndex);// TextureID program, const GLchar* uniformBlockName);
    LE(glUniformBlockBinding);// TextureID program, TextureID uniformBlockIndex,
                              // TextureID uniformBlockBinding);
    ...
    LE(glDrawElementsInstancedBaseVertex);// GLenum mode, GLsizei count, GLenum type,
    ...
    LE(glBlendFuncSeparate);// GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha,
                            // GLenum dfactorAlpha);
    LE(glGetBufferSubData);// GLenum target, GLintptr offset, GLsizeiptr size, GLvoid*
                           // data);
  ...
  // We use the Win32 capture API (GetCapture/SetCapture/ReleaseCapture) to be able to read
  // mouse coordinations when dragging mouse outside of our window bounds.
  static IMGUI_API LRESULT ImGui_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
  {
    ...
    case WM_MBUTTONDOWN: {
      ...
      if (!IsAnyMouseButtonDown() && GetCapture() == NULL) SetCapture(hwnd);
    ...
    case WM_MBUTTONUP: {
      ...
      if (!IsAnyMouseButtonDown() && GetCapture() == hwnd) ReleaseCapture();
      return 0;
    }
    case WM_MOUSEWHEEL:
  ...
  // setting up 'RenderDrawListsFn' in the ImGuiIO structure) Note that this implementation
  // is little overcomplicated because we are saving/setting up/restoring every OpenGL state
  // explicitly, in order to be able to run within any OpenGL engine that doesn't do so. If
  // text or lines are blurry when integrating ImGui in your engine: in your Render function,
  ...
  bool ImGui_CreateFontsTexture()
  {
    ...
    io.Fonts->GetTexDataAsRGBA32(&pixels,
      &width,
      &height);// Load as RGBA 32-bits (75% of the memory is wasted, but default font
...
#undef OFFSETOF
  ...
  bool ImGui_Init()
  {
    ...
    io.KeyMap[ImGuiKey_Tab] =
      VK_TAB;// Keyboard mapping. ImGui will use those indices to peek into the
    ...
    // io.RenderDrawListsFn = ImGui_RenderDrawLists;       // Alternatively you can set
    // this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same
    // ImDrawData pointer.
    /*
  ...
  void ImGui_Shutdown() { ImGui_InvalidateDeviceObjects(); }

  void ImGui_NewFrame()
  {
    if (!g_FontTexture) ImGui_CreateDeviceObjects();
    ...
    // Setup inputs
    // (we already got mouse wheel, keyboard keys & characters from glfw callbacks polled
    in glfwPollEvents()) if (glfwGetWindowAttrib(g_Window, GLFW_FOCUSED))
    {
        if (io.WantMoveMouse)
        {
            glfwSetCursorPos(g_Window, (double)io.MousePos.x, (double)io.MousePos.y);   //
    Set mouse position if requested by io.WantMoveMouse flag (used when io.NavMovesTrue is
    enabled by user and using directional navigation)
        ...
        else
        {
            ...
            io.MousePos = ImVec2((float)mouse_x, (float)mouse_y);   // Get mouse position
    in screen coordinates (set to -1,-1 if no mouse / on another screen, etc.)
        }
    }
    else
    {
    ...
    miss click-release events that are shorter than 1 frame. g_MousePressed[i] = false;
    }
    ...
    glfwSetInputMode(g_Window, GLFW_CURSOR, io.MouseDrawCursor ? GLFW_CURSOR_HIDDEN :
    GLFW_CURSOR_NORMAL);
    */
    // Start the frame
    ImGui::NewFrame();
...
int    ImApp::g_AttribLocationPosition = 0, ImApp::g_AttribLocationUV = 0,
    ImApp::g_AttribLocationColor = 0;
...
void ERRCHECK_fn(FMOD_RESULT result, const char *file, int line)
{
  if (result != FMOD_OK) {
    ...
    Common_Fatal("%s(%d): FMOD error %d - %s", file, line, result,
