...
static const YYACTIONTYPE yy_action[] = {
    /*     0 */ 9, 5, 1,  3, 2, 28, 15, 24, 5, 1,
    /*    10 */ 3, 2, 27, 4, 6, 20, 23, 22, 7, 3,
    /*    20 */ 2, 8,
};
static const YYCODETYPE yy_lookahead[] = {
    /*     0 */ 9, 1, 2,  3,  4,  9,  6,  0,  1, 2,
    /*    10 */ 3, 4, 9,  5,  9,  7,  10, 8,  9, 3,
    /*    20 */ 4, 9, 10, 10, 10, 10, 10, 10, 8, 8,
};
...
static const YYACTIONTYPE yy_default[] = {
    /*     0 */ 21, 21, 21, 21, 21, 21, 21, 21, 26, 29,
};
...
)
{
    ...
    do
    {
        ...
        {
            assert(i >= 0 &&
                   i < (int)(sizeof(yy_action) / sizeof(yy_action[0])));
            return yy_action[i];
        }
    } while (1);
}
...
static const YYCODETYPE yyRuleInfoLhs[] = {
    8, /* (0) program ::= expr */
    9, /* (1) expr ::= OPENP expr CLOSEP */
    9, /* (2) expr ::= expr PLUS expr */
    9, /* (3) expr ::= expr DIVIDE expr */
    9, /* (4) expr ::= expr TIMES expr */
    9, /* (5) expr ::= expr MINUS expr */
    9, /* (6) expr ::= DOUBLE */
};
    ...
    { /* Exit by "break" */
        ...
        if (yyact >= YY_MIN_REDUCE)
        {
            unsigned int yyruleno =
                yyact - YY_MIN_REDUCE; /* Reduce by this rule */
#ifndef NDEBUG
            assert(yyruleno <
            ...
            ** enough on the stack to push the LHS value */
            ...
            yyact =
                yy_reduce(yypParser, yyruleno, yymajor, yyminor ParseCTX_PARAM);
        }
