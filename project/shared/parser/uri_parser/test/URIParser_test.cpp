...
TEST(URIParser, IPV6URI)
{
  ...
  auto parser  = std::make_unique<URIParser>();
  auto sip_uri = std::string("http://foo@[2001:db8::8a2e:370:7334]:81/a/b/c?x=7&y=11#hola");
  parser->execute(sip_uri.data(), sip_uri.length(), 0, values);
...
TEST(URIParser, IPV6URI_WithoutFrag)
{
  ...
  auto parser  = std::make_unique<URIParser>();
  auto sip_uri = std::string("http://foo@[2001:db8::8a2e:370:7334]:81/a/b/c?x=7&y=11");
  parser->execute(sip_uri.data(), sip_uri.length(), 0, values);
...
TEST(URIParser, IPV6URI_WithoutUser)
{
  ...
  auto parser  = std::make_unique<URIParser>();
  auto sip_uri = std::string("http://[2001:db8::8a2e:370:7334]:81/a/b/c?x=7&y=11");
  parser->execute(sip_uri.data(), sip_uri.length(), 0, values);
