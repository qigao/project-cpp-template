...
TEST(ParserPerformance, ragel_dump) {
  http_parser_settings settings_dump = {
      on_message_begin_dump, on_url_dump,
      on_status_dump,        on_header_field_dump,
      on_header_value_dump,  on_headers_complete_dump,
      on_body_dump,          on_message_complete_dump};
