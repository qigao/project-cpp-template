...
macro(project_options)
    ...
    cmake_parse_arguments(
        ProjectOptions "${options}" "${oneValueArgs}" "${multiValueArgs}"
        ${ARGN}
    )
    ...
    if(NOT "${ProjectOptions_ENABLE_IPO}" STREQUAL "")
        message(
            WARNING
                "Deprecation: Use ENABLE_INTERPROCEDURAL_OPTIMIZATION instead of ENABLE_IPO"
        )
    ...
    if(${ProjectOptions_ENABLE_GCC_ANALYZER})
        enable_gcc_analyzer(
            ${_options_target} "${ProjectOptions_GCC_ANALYZER_EXTRA_ARGUMENTS}"
        )
    endif()
