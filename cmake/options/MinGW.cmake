...
function(is_mingw value)
  ...
  if(MINGW
     OR ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU" AND "${CMAKE_C_COMPILER_ID}"
                                                       STREQUAL "GNU")
  ...
  if(NOT CMAKE_CXX_COMPILER
    ...
    if((DETECTED_CMAKE_CXX_COMPILER_ID STREQUAL "GNU"
        AND DETECTED_CMAKE_C_COMPILER_ID STREQUAL "GNU")
    )
      set(${value} ON PARENT_SCOPE)
      return()
...
macro(configure_mingw_vcpkg)
  ...
  if(${_is_mingw})
    ...
    set(VCPKG_CMAKE_SYSTEM_NAME "MinGW" CACHE STRING "")
    set(VCPKG_TARGET_IS_MINGW TRUE CACHE STRING "")
    ...
    set(VCPKG_LIBRARY_LINKAGE ${MINGW_LINKAGE} CACHE STRING "")
    ...
    set(VCPKG_DEFAULT_TRIPLET "${_arch}-mingw-${MINGW_LINKAGE}"
    ...
    elseif(CROSSCOMPILING AND HOST_TRIPLET)
      set(VCPKG_DEFAULT_HOST_TRIPLET "${HOST_TRIPLET}"
          CACHE STRING "Default target triplet for vcpkg"
      )
