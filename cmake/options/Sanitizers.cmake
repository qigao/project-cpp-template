...
function(
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES
        ...
        if(${ENABLE_SANITIZER_MEMORY} AND CMAKE_CXX_COMPILER_ID MATCHES
                                          ".*Clang"
        )
            message(
                WARNING
            ...
            if("address" IN_LIST SANITIZERS OR "thread" IN_LIST SANITIZERS
        ...
        if(NOT "${LIST_OF_SANITIZERS}" STREQUAL "")
            if(NOT MSVC)
                target_compile_options(
                    ${_project_name} INTERFACE -fsanitize=${LIST_OF_SANITIZERS}
                )
                target_link_options(
                    ${_project_name} INTERFACE -fsanitize=${LIST_OF_SANITIZERS}
                )
            else()
                string(FIND "$ENV{PATH}" "$ENV{VSINSTALLDIR}"
        ...
        if(NOT "${LIST_OF_SANITIZERS}" STREQUAL "")
            ...
            if("undefined" IN_LIST SANITIZERS)
                set(${ENABLE_SANITIZER_UNDEFINED_BEHAVIOR}
                    "ENABLE_SANITIZER_UNDEFINED_BEHAVIOR" PARENT_SCOPE
                )
            endif()
