  ...
  if(CMAKE_BUILD_TYPE STREQUAL "Release" OR CMAKE_BUILD_TYPE STREQUAL
    ...
    if(result AND NOT ${_is_mingw})
      ...
      set_target_properties(
        ${_project_name} PROPERTIES INTERPROCEDURAL_OPTIMIZATION ON
      )
    else()
      message(
        WARNING
...
macro(enable_native_optimization _project_name)
  ...
  if("${_arch}" STREQUAL "x64")
    message(
      STATUS
        "Enabling the optimizations specific to the current build machine (less portable)"
    )
    if(MSVC)
...
macro(disable_exceptions _project_name)
  target_compile_options(
    ${_project_name}
    INTERFACE $<$<AND:$<COMPILE_LANGUAGE:CXX>,$<CXX_COMPILER_ID:MSVC>>:/EHs-c-
              /D_HAS_EXCEPTIONS=0>
  )
  target_compile_options(
    ${_project_name}
...
macro(disable_rtti _project_name)
  target_compile_options(
    ${_project_name}
    INTERFACE $<$<AND:$<COMPILE_LANGUAGE:CXX>,$<CXX_COMPILER_ID:MSVC>>:/GR->
  )
  target_compile_options(
    ${_project_name}
    INTERFACE
