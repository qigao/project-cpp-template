...
macro(dynamic_project_options)
  option(
    ...
    "Set up defaults for a developer of the project, and let developer change options"
    OFF
  )
  ...
  foreach(option ${options})
    ...
    if(OPT_${option_name})
      ...
      if(option_type EQUAL 0)
        option(OPT_${option_name} "${option_description}"
               ${option_implicit_default}
        )
      else()
        option(OPT_${option_name} "${option_description}"
               "${option_implicit_default}"
      ...
      if(option_type EQUAL 0)
        cmake_dependent_option(
          OPT_${option_name} "${option_description}"
          ${option_developer_default} ENABLE_DEVELOPER_MODE
          ${option_user_default}
        )
      else()
        cmake_dependent_option(
