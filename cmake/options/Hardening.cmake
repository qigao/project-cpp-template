...
function(
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES
    ...
    if(${ENABLE_STACK_PROTECTION})
      ...
      if(APPLE)
        ...
        if(CMAKE_SYSTEM_PROCESSOR MATCHES "arm64" AND CMAKE_CXX_COMPILER_ID
                                                      MATCHES ".*Clang"
        )
    ...
    if(${ENABLE_OVERFLOW_PROTECTION})
      ...
      if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        list(APPEND HARDENING_COMPILE_OPTIONS -Wstringop-overflow=4
             -Wformat-overflow=2
        )
      endif()
    ...
    if(${ENABLE_ELF_PROTECTION})
      set_target_properties(
        ${_project_name} PROPERTIES POSITION_INDEPENDENT_CODE ON
      )
      list(APPEND HARDENING_LINK_OPTIONS -Wl,-z,relro -Wl,-z,noexecstack
           -Wl,-z,separate-code
      )
  ...
  target_compile_options(
    ${_project_name}
    INTERFACE $<$<COMPILE_LANGUAGE:CXX>:${HARDENING_COMPILE_OPTIONS}>
              $<$<COMPILE_LANGUAGE:C>:${HARDENING_COMPILE_OPTIONS}>
  )

  target_link_options(
    ${_project_name} INTERFACE
    $<$<COMPILE_LANGUAGE:CXX>:${HARDENING_LINK_OPTIONS}>
