...
macro(_find_vcpkg_repository)
  if(NOT "${_vcpkg_args_VCPKG_DIR}" STREQUAL "")
    ...
    get_filename_component(
      VCPKG_PARENT_DIR "${_vcpkg_args_VCPKG_DIR}" DIRECTORY
    )
  else()
...
macro(_clone_vcpkg_repository)
  ...
  git_clone(REPOSITORY_PATH "${_vcpkg_args_VCPKG_DIR}" REMOTE_URL
...
macro(_update_vcpkg_repository)
  if(${_vcpkg_args_ENABLE_VCPKG_UPDATE})
    git_pull(REPOSITORY_PATH "${_vcpkg_args_VCPKG_DIR}" TARGET_REVISION
  ...
  if(NOT EXISTS "${_vcpkg_args_VCPKG_DIR}/vcpkg${CMAKE_EXECUTABLE_SUFFIX}"
    ...
    if(WIN32)
      execute_process(
        ...
        WORKING_DIRECTORY "${_vcpkg_args_VCPKG_DIR}" COMMAND_ERROR_IS_FATAL
                          LAST
      )
    else()
      execute_process(
...
macro(_is_vcpkg_outdated)
  ...
  elseif(NOT "${_vcpkg_args_VCPKG_REV}" STREQUAL ""
         AND NOT "${_REVISION}" STREQUAL "${_vcpkg_args_VCPKG_REV}"
  )
...
macro(_checkout_vcpkg_repository)
  if(NOT "${_vcpkg_args_VCPKG_REV}" STREQUAL "")
    git_checkout(
      REPOSITORY_PATH "${_vcpkg_args_VCPKG_DIR}" REVISION
      "${_vcpkg_args_VCPKG_REV}"
    )
  endif()
endmacro()
...
macro(_cross_compiling_vcpkg)
  if(CROSSCOMPILING)
    ...
    message(
      STATUS
        "Use cross-compiler toolchain for vcpkg: ${VCPKG_CHAINLOAD_TOOLCHAIN_FILE}"
    )
  endif()
endmacro()
